...
async def process_files_stream(folder_path: str, files: List[UploadFile]) -> AsyncGenerator[str, None]:
    ...
    try:
        ...
        for idx, file in enumerate(all_files):
            summary = await summarize_file(file)  # Make sure this is async
        ...
        for idx, file in enumerate(sorted_files):
            ...
            # Convert file
            converted_file = await convert_cobol_to_python(
            ...
            await ai_agent(parsed_code, parsed_test, file, folder_path)
