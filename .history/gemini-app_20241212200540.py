...
def convert_cobol_to_python(cobol_source_code: str , context) -> Code:
    """
    ...
    try:
        ...
        conversion_prompt_template = PromptTemplate(
            ...
            Source COBOL Code:
            Consider the context of files which the below code is dependent on : The context is : {context}
...
def process_files(folder_path: str):
    ...
    for converted  in converted_files:
        code = ai_agent(converted.completePythonCode , converted.singleTestAssertLine , converted.file_name)
