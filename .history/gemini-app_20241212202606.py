...
GITHUB_CLIENT_SECRET = 'YOUR_GITHUB_CLIENT_SECRET'  # Replace with your GitHub OAuth App Client Secret
...
def process_files(folder_path: str):
    ...
    for file in sorted_files:
        ...
        ai_agent(parsed_code , converted_file.singleTestAssertLine , file , folder_path)
